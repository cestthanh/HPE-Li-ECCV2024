...
def compute_demo_diagnostics(pred_pose, gt_pose, output_dims):
    ...
    diagnostics = {
        ...
        "g_PCK@10": float(metrics["g_PCK@10"]),
        "g_PCK@20": float(metrics["g_PCK@20"]),
        "g_PCK@30": float(metrics["g_PCK@30"]),
        "g_PCK@40": float(metrics["g_PCK@40"]),
        "g_PCK@50": float(metrics["g_PCK@50"]),
